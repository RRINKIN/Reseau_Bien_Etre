 ...
 */
final class Version20231215214143 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Create relations Commentaire';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE commentaire ADD prestataire_id INT DEFAULT NULL, ADD internaute_id INT DEFAULT NULL');
