...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('LQ2-1zOp7A', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qTgEzbJcVP', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uO79-YvARW', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\AbusRepository' => ['privates', 'App\\Repository\\AbusRepository', 'getAbusRepositoryService', true],
            'App\\Repository\\BlocRepository' => ['privates', 'App\\Repository\\BlocRepository', 'getBlocRepositoryService', true],
            'App\\Repository\\CategorieDeServicesRepository' => ['privates', 'App\\Repository\\CategorieDeServicesRepository', 'getCategorieDeServicesRepositoryService', true],
            'App\\Repository\\CodePostalRepository' => ['privates', 'App\\Repository\\CodePostalRepository', 'getCodePostalRepositoryService', true],
            'App\\Repository\\CommentaireRepository' => ['privates', 'App\\Repository\\CommentaireRepository', 'getCommentaireRepositoryService', true],
            'App\\Repository\\CommuneRepository' => ['privates', 'App\\Repository\\CommuneRepository', 'getCommuneRepositoryService', true],
            'App\\Repository\\ImagesRepository' => ['privates', 'App\\Repository\\ImagesRepository', 'getImagesRepositoryService', true],
            'App\\Repository\\InternauteRepository' => ['privates', 'App\\Repository\\InternauteRepository', 'getInternauteRepositoryService', true],
            ...
            'App\\Repository\\AbusRepository' => '?',
            'App\\Repository\\BlocRepository' => '?',
            'App\\Repository\\CategorieDeServicesRepository' => '?',
            'App\\Repository\\CodePostalRepository' => '?',
            'App\\Repository\\CommentaireRepository' => '?',
            'App\\Repository\\CommuneRepository' => '?',
            'App\\Repository\\ImagesRepository' => '?',
            'App\\Repository\\InternauteRepository' => '?',
    ...
    {
        return $container->privates['api_platform.cache.metadata.property'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Mv+RzroPbP', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('s8SfrXfIbj', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource_collection'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tFV5uQ--KD', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['api_platform.cache.route_name_resolver'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OL++J+esU2', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('+WuRYBfflz', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('RcfUiYBlvw', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9eoaXsU53L', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PU7BftiMW1', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JFQQaGfMyc', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDebug_SerializerService($container)
    {
        ...
        $h = ($container->privates['serializer.data_collector'] ??= new \Symfony\Component\Serializer\DataCollector\SerializerDataCollector());
        ...
        $k = new \ApiPlatform\OpenApi\Serializer\ApiGatewayNormalizer(new \ApiPlatform\OpenApi\Serializer\OpenApiNormalizer(new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(NULL, NULL, $g, $a)], [$j])));
        $l = ($container->privates['api_platform.router'] ?? self::getApiPlatform_RouterService($container));
        ...
        $p = new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($b, $c, $m, $d, $n, $e, $g, $i, $o, [], $f);
        $q = new \ApiPlatform\Serializer\ItemNormalizer($c, $m, $d, $n, $g, $i, $o, NULL, $b, $f);
        ...
        $t = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($o, $i, $g, $a, $s, NULL);
        $u = new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL);

        return $container->privates['debug.serializer'] = new \Symfony\Component\Serializer\Debug\TraceableSerializer(new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($g), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Serializer\ConstraintViolationListNormalizer([], $i), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($k, $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer($l, [], $i), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Problem\Serializer\ConstraintViolationListNormalizer([], $i), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($k, $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($p, $i), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($b, $c, $m, $n, $l, $i), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($b, $d, $l), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\ErrorNormalizer($l, true, []), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($q, $i), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Problem\Serializer\ErrorNormalizer(true, []), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, translator: $r), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\TranslatableNormalizer($r), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($p, $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($q, $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $i), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($o, $i, $a, $s, NULL)), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($container->privates['mime_types'] ?? self::getMimeTypesService($container))), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($e, $n, $d, NULL), 'page', 'pagination', $b, $g), $b, $n, ($container->privates['api_platform.filter_locator'] ??= new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [], []))), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($t, $d, $e), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($t, $h)], [new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\XmlEncoder(), $h), new \Symfony\Component\Serializer\Debug\TraceableEncoder($j, $h), new \Symfony\Component\Serializer\Debug\TraceableEncoder($u, $h), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\CsvEncoder(), $h), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonopenapi', NULL), $h), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\YamlEncoder('yamlopenapi', $u), $h), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonld', NULL), $h), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonproblem'), $h)]), $h);
    }
