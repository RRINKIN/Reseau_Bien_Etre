...
function PrestataireSearchBar({onSearchChange}) {
        ...
        <>
            <button className="flex flex-row items-center pointer-events-auto bg-zinc-200 rounded-full h-10 md:h-12 md:w-auto border-none my-10">
                <svg 
                    ...
                    viewBox="0 0 512 512"
                    className="fill-zinc-400 w-10 mx-3 h-5"
                    onClick={(e) => onSearchChange(searchValue)}
                    >
...
export default PrestataireSearchBar